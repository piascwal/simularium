...
(function(){
  ...
  // ==========================================================================
  // CATALOGUE DE PRIMITIVES COMPORTEMENTALES
  // Chaque brique de comportement est documentée avec son statut scientifique :
  ...
  // "ceci est une rustine technique", plutôt que de laisser croire que tout
  // vient de la littérature éthologique.
  // ==========================================================================
  const PRIMITIVES = {
    poursuivre: {
      label: 'Poursuite',
  ...
  const SCENARIO_SLIDER_DEFAULTS = {
    heider:  { perception:230, force:12, speed:45, panicRadius:80,  avoidance:30 },
    ants:    { perception:120, force:12, speed:45, panicRadius:80,  avoidance:30 },
    poisson: { perception:110, force:12, speed:45, panicRadius:80,  avoidance:30, cohesion:4, alignment:10, separation:12 },
    foule:   { perception:180, force:12, speed:45, panicRadius:140, avoidance:30 }
  };
